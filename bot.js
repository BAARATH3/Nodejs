...
var bot_token = '5707838725:AAEnKc8ABi_Gmlk7ImFAY605n7Zn0s1tYAI'; //YOUR BOT TOKEN HERE
var bot_name = "NodeJsV2_Bot" // Bot username here without @
var gateway = "B";
/* A = Cash_RewardPe
   B = Full2SMS
   C = Bharatiify
...
//CONNECT TO MONGO
mongo.connect('mongodb+srv://otto:otto@cluster0.ehnab.mongodb.net/?retryWrites=true&w=majority', {
...
bot.hears('/panel', async (ctx) => {
  try {
    ...
    if (ctx.from.id == 2131044278 || ctx.from.id == 5137401364) {
